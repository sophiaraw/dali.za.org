...
@TestFor(CostCentreController)
@Mock(CostCentre)
class CostCentreControllerTests {
    ...
    void testShow() {
        ...
        populateValidParams(params)
        def costCentre = new CostCentre(params)
    ...
    void testDelete() {
        ...
        assert CostCentre.count() == 0
        assert CostCentre.get(costCentre.id) == null
        assert response.redirectedUrl == '/costCentre/list'
    }
}
